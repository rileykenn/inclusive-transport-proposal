...
function Hero() {
    ...
    return (
        <section className="relative pt-[72px] overflow-hidden">
            {/* ── Dark Top: Images + Heading ── */}
            <div className="relative bg-[var(--color-accent)] pb-16 sm:pb-20">
                ...
                <div className="absolute inset-0 overflow-hidden pointer-events-none">
                    ...
                    <div className="absolute bottom-10 left-[5%] w-48 h-48 rounded-full bg-[var(--color-primary)]/10 blur-2xl float-animation" style={{ animationDelay: "2s" }} />
                </div>
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-6">
                    ...
                    >
                        ...
                        <h1 className="text-4xl sm:text-5xl lg:text-7xl font-extrabold text-white leading-[1.1] mb-0">
                            Your Journey,{" "}
            ...
            {/* ── Light Bottom: Description, CTAs, Badges, Reviews ── */}
            <div className="relative bg-white py-12 sm:py-16">
                <div className="max-w-7xl mx-auto px-6 text-center">
                    ...
                    >
                        <p className="text-lg sm:text-xl text-[var(--color-text-secondary)] leading-relaxed mb-10 max-w-2xl mx-auto">
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            ...
                            <a
                                href="tel:0402503701"
                                className="inline-flex items-center justify-center gap-2 bg-[var(--color-surface-alt)] border-2 border-gray-200 hover:border-[var(--color-primary)] text-[var(--color-text)] px-8 py-4 rounded-full text-base font-bold transition-all"
                            >
                                <Phone size={18} />
                                0402 503 701
                            </a>
                    ...
                    <motion.div
                        ...
                        className="flex flex-wrap justify-center gap-6 sm:gap-8 mt-10 pt-8 border-t border-gray-200"
                    >
                        {[
                        ...
                        <div className="hidden sm:grid grid-cols-2 gap-4">
                            {reviews.map((review, i) => (
                                <motion.div
                                    ...
                                    className="bg-[var(--color-surface-alt)] rounded-2xl p-5 border border-gray-200 hover:border-[var(--color-primary)]/40 hover:shadow-lg transition-all duration-300 text-left"
                                >
                                    <div className="flex items-center gap-3 mb-3">
                                        ...
                                        <div>
                                            <p className="text-[var(--color-text)] font-semibold text-sm">{review.name}</p>
                        ...
                        <div className="sm:hidden relative min-h-[140px]">
                            <AnimatePresence mode="wait">
                                <motion.div
                                    ...
                                    className="bg-[var(--color-surface-alt)] rounded-2xl p-5 border border-gray-200 text-left"
                                >
                                    <div className="flex items-center gap-3 mb-3">
                                        <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[var(--color-primary)] to-[var(--color-primary-dark)] flex items-center justify-center text-white font-bold text-sm">
                                        ...
                                        <div>
                                            <p className="text-[var(--color-text)] font-semibold text-sm">{reviews[activeReview].name}</p>
                                            <div className="flex gap-0.5">
                            ...
                            <div className="flex justify-center gap-2 mt-3">
                                {reviews.map((_, i) => (
                                    <button
                                        ...
                                        className={`w-2 h-2 rounded-full transition-all ${i === activeReview ? "bg-[var(--color-primary)] w-6" : "bg-gray-300"}`}
                                    />
                                ))}
                            </div>
                        </div>
